...
GP = ((course1*course1_cg) + (course2*course2_cg) + (course3*course3_cg) + (course4*course4_cg) + (course5*course5_cg) + (course6*course6_cg) + (course7*course7_cg) + (course8*course8_cg) + (course9*course9_cg))
